...
const RegistrationLink = (id: number) => {
  if (id < 1) {
    return (
      <Nav.Link href="/Components/Registration/Registration">
        Registration
      </Nav.Link>
    );
  }
...
const SemesterOpeningLink = (id: number) => {
  if (id > 0) {
    return (
      <NavDropdown.Item href="/Prototypes/SemesterOpeningView">
        SemesterOpeningView
      </NavDropdown.Item>
    );
  }
...
const ListAttendancesLink = (id: number) => {
  if (id > 0) {
    return (
      <Nav.Link href="/Components/ListAttendances/ListAttendances">
        ListAttendances
      </Nav.Link>
    );
  }
...
const ListStudentsLink = (id: number) => {
  if (id > 0) {
    return (
      <Nav.Link href="/Components/ListStudents/ListStudents">
        ListStudents
      </Nav.Link>
    );
  }
...
const AddAttendanceViewLink2 = (id: number) => {
  if (id > 0) {
    return (
      <NavDropdown.Item href="/Prototypes/AddAttendanceView">
        AddAttendanceView
      </NavDropdown.Item>
    );
  }
...
const AddAttendanceViewLink = (id: number) => {
  if (id > 0) {
    return (
      <Nav.Link href="/Components/AddAttendanceView/AddAttendanceView">
        AddAttendanceView
      </Nav.Link>
    );
  }
