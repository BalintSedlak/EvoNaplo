...
namespace EvoNaplo.WebApp.Services
{
    public class SemesterService
    {
        ...
        public async Task JoinSemester(int id)
        {
            ...
            await _evoNaploContext.UsersOnSemester.AddAsync(new EvoNaplo.Infrastructure.Models.TableConnectors.UsersOnSemester(id,_evoNaploContext.Semesters.Max(s => s.Id)));
            _evoNaploContext.SaveChanges();
        }
    }
}
